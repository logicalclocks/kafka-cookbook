...
default['kkafka']['default']['public_ips']                                         = node["install"]["public_ips"].empty? ? ['10.0.2.15'] : node["install"]["public_ips"]  
default['kkafka']['default']['private_ips']                                        = node["install"]["private_ips"].empty? ? ['10.0.2.15'] : node["install"]["private_ips"]
